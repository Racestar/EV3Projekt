...
#pragma warning restore
    ...
    public class TouchSensor : Sensor
    {
        ...
        /// </summary>
        public TouchSensor()
            : base((SensorMode)TouchMode.Boolean)
        {
        ...
        /// </summary>
        /// <param name="mode">Mode.</param>
        public TouchSensor(TouchMode mode)
            : base((SensorMode)mode)
        {
...
#pragma warning restore
    ...
    public class ColorSensor : Sensor
    {
        ...
        /// </summary>
        public ColorSensor()
            : base((SensorMode)ColorMode.Color)
        {
        ...
        /// </summary>
        /// <param name="mode">Mode.</param>
        public ColorSensor(ColorMode mode)
            : base((SensorMode)mode)
        {
        ...
        /*NXT color sensor wird momentan nicht benutzt
        /// <summary>
        /// Reads the sensor value as a string.
        /// </summary>
        /// <returns>The value as a string</returns>
    ...
    public class IRSensor : Sensor
    {
        ...
        /// </summary>
        public IRSensor()
            : base((SensorMode)IRMode.Proximity)
        {
    ...
    public class LightSensor : Sensor
    {
        ...
        /// </summary>
        public LightSensor()
            : base((SensorMode)LightMode.Relection)
        {
        ...
        /// </summary>
        /// <param name="mode">Mode.</param>
        public LightSensor(LightMode mode)
            : base((SensorMode)mode)
        {
    ...
    public class SoundSensor : Sensor
    {
        ...
        /// </summary>
        public SoundSensor()
            : base((SensorMode)SoundMode.SoundDBA)
        {
        ...
        /// </summary>
        /// <param name="mode">Mode.</param>
        public SoundSensor(SoundMode mode)
            : base((SensorMode)mode)
        {
...
#pragma warning restore
    ...
    class UltrasonicSensor : Sensor
    {
        ...
        public UltrasonicSensor()
            : base((SensorMode)UltrasonicMode.Centimeter)
        {
        ...
        /// </summary>
        /// <param name="mode">Mode.</param>
        public UltrasonicSensor(UltrasonicMode mode)
            : base((SensorMode)mode)
        {
...
#pragma warning restore
    ...
    class TemperatureSensor : Sensor
    {
        ...
        public TemperatureSensor()
            : base((SensorMode)TemperatureMode.Celcius)
        {
        ...
        /// </summary>
        /// <param name="mode">Mode.</param>
        public TemperatureSensor(TemperatureMode mode)
            : base((SensorMode)mode)
        {
...
#pragma warning restore
    ...
    class GyroSensor : Sensor
    {
        ...
        /// </summary>
        public GyroSensor()
            : base((SensorMode)GyroMode.Angle)
        {
        ...
        /// </summary>
        /// <param name="mode">Mode.</param>
        public GyroSensor(GyroMode mode)
            : base((SensorMode)mode)
        {
