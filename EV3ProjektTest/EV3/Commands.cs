...
#pragma warning restore
    ...
    public class Command : BrickCommand
    {
        ...
        public Command(ByteCodes byteCode, int globalVariables, int localVariables, UInt16 sequenceNumber, bool reply)
            : this(globalVariables, localVariables, sequenceNumber, reply)
        {
